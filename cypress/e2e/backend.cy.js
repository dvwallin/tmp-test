...
const grafanaUrl = `${Cypress.env("grafanaUrl")}`
const prometheusUrl = `${Cypress.env("prometheusUrl")}`
...
describe('Platform Engineer - Level 3', () => {
  ...
  it('Starts up a grafana instance', () => {
    cy.request({
      failOnStatusCode: false,
      method: 'GET',
      url: `${grafanaUrl}`,
  ...
  it('Starts up a prometheus instance', () => {
    cy.request({
      failOnStatusCode: false,
      method: 'GET',
      url: `${prometheusUrl}`,
